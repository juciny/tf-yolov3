...
ANCHORS          = utils.get_anchors('./data/video_anchors.txt', IMAGE_H, IMAGE_W)
NUM_CLASSES      = len(CLASSES)
EVAL_INTERNAL    = 100

train_tfrecord   = "./video_dataset/video_train.tfrecords"
test_tfrecord    = "./video_dataset/video_test.tfrecords"
